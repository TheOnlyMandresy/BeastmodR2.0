(function () {
	...
	var defaultOptions = {
		...
		/**
		 * OFF
		 * subscript,emoticon,date,time,print,maximize,superscript,ltr,rtl,font,
		 */
		 ...
		 * @type {string}
		 */
		fonts: '"Sora",Arial,Arial Black,Comic Sans MS,Courier New,Georgia,Impact,' +
